...
bool omo_open_split_track_dialog(OMO_UI * uip, void * data)
{
	...
	h = 8 + (al_get_font_line_height(uip->main_theme->gui_theme[OMO_THEME_GUI_THEME_LIST_BOX]->state[0].font) + 8) * 2 + 8 + 32 + 12;
